...
?>
							...
							<td>
<?php
								echo "<input form=\"update{$row[0]}\" type=\"text\" name=\"activate\" value=\"", $row[13] === null ? 'NULL' : $row[13], "\"/>\n";
?>
								.
							</td>
							<td>
<?php
								echo "<input form=\"update{$row[0]}\" type=\"text\" name=\"deactivate\" value=\"", $row[14] === null ? 'NULL' : $row[14], "\"/>\n";
?>
								.
							</td>
							<td>
<?php
								echo "<input form=\"update{$row[0]}\" type=\"checkbox\" name=\"active\"", $row[15] == 't' ? ' checked="checked"' : '', "/>\n";
?>
								.
							</td>
							<td>
