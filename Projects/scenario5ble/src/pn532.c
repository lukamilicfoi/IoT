...
/* a bug was fixed here: "#define portTICK_RATE_MS portTICK_PERIOD_MS" was added */
#ifndef _BV
...
/* a bug was fixed here: "#define gpio_pad_select_gpio esp_rom_gpio_pad_select_gpio" was added */
...
/* a bug was fixed here: " - 1" was added */
    memcpy(data, pn532_packetbuffer + 8 - 1, 16);
